...
# Database
DB_URI = os.environ.get("DATABASE_URL", "postgres://bkbidutw:8Y5OYoO7fVhwp6T8k4GfPwjBrXgY78-A@flora.db.elephantsql.com/bkbidutw")

PROTECT_CONTENT = strtobool(os.environ.get("PROTECT_CONTENT", "False"))

# ID dari Channel Atau Group Untuk Wajib Subscribenya
FORCE_SUB_1 = int(os.environ.get("FORCE_SUB_1", "-1001757481471"))
FORCE_SUB_2 = int(os.environ.get("FORCE_SUB_2", "-1001673728150"))
